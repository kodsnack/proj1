...
var i__4790__auto___32055 = (0);
while(true){
if((i__4790__auto___32055 < len__4789__auto___32054)){
args__4795__auto__.push((arguments[i__4790__auto___32055]));

var G__32056 = (i__4790__auto___32055 + (1));
i__4790__auto___32055 = G__32056;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq31979){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq31979));
}));
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq31991){
var G__31992 = cljs.core.first(seq31991);
var seq31991__$1 = cljs.core.next(seq31991);
var G__31994 = cljs.core.first(seq31991__$1);
var seq31991__$2 = cljs.core.next(seq31991__$1);
var G__31995 = cljs.core.first(seq31991__$2);
var seq31991__$3 = cljs.core.next(seq31991__$2);
var G__31996 = cljs.core.first(seq31991__$3);
var seq31991__$4 = cljs.core.next(seq31991__$3);
var G__31997 = cljs.core.first(seq31991__$4);
var seq31991__$5 = cljs.core.next(seq31991__$4);
var G__31998 = cljs.core.first(seq31991__$5);
var seq31991__$6 = cljs.core.next(seq31991__$5);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31992,G__31994,G__31995,G__31996,G__31997,G__31998,seq31991__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__32023){
var vec__32026 = p__32023;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32026,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32026,(1),null);
